<template>
  <div>
    ...
    <el-dialog title="每日推荐" :visible.sync="pushDialogVisible" width="60%" :append-to-body="true"
      :close-on-click-modal="false" class="index-push" center>
    ...
    methods: {
      ...
      prevPage () {
        if (this.currentPage > 1) {
          this.currentPage--;
          // this.getArticles();
          window.location.href = `http://1.94.101.104:${window.location.port}/index?currentPage=${this.currentPage}`;
